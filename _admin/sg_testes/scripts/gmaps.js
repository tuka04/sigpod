function showGMaps() {
    ...
    google.maps.event.addListener(map, 'rightclick', function(event) {
    	...
    	newObraInfoWindow.setContent('<a href="sgo.php?acao=novaObra&amp;coord='+event.latLng.lat()+'|'+event.latLng.lng()+'" target="_parent" style="font-size: 10pt; font-family: Arial, sans-serif; color:#BE1010;">Adicionar Nova Obra neste local</a><br />'+
    			'<a href="sgo.php?acao=novaObra&amp;coord='+event.latLng.lat()+'|'+event.latLng.lng()+'" target="_parent" style="font-size: 10pt; font-family: Arial, sans-serif; color:#BE1010;">Selecionar obra para esse local</a>');
