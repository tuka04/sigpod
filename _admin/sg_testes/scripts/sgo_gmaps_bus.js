					...
					google.maps.event.addListener(marker, 'click', function(event) {
						...
						var infowindow = new google.maps.InfoWindow({
							content: '<span style="font-family: arial, sans-serif; font-weight: bold;">'+obra.nome+'</span><br />'
								...
								+descr+'<br /><br />'
								+'<a href="javascript:void(0)" onclick="javascript:window.open(\'sgo.php?acao=verObra&amp;obraID='+obra.id+'\',\'obra_det\',\'width=\'+screen.width*newWinWidth+\',height=\'+screen.height*newWinHeight+\',scrollbars=yes,resizable=yes\').focus()" style="font-family: arial, sans-serif; font-size: 10pt; color: #BE1010;">Ver p&aacute;gina da obra</a>'
						});
