...
class adLDAP {
    ...
    */
    function __construct($options = array()) 
    {
    	...
    	$this->accountSuffix     = $conf['accountSuffix'];
   		$this->baseDn            = $conf['baseDn'];
		$this->domainControllers = $conf['domainControllers'];
		$this->adminUsername     = $conf['adminUsername'];
    	$this->adminPassword     = $conf['adminPassword'];
	    $this->realPrimaryGroup  = $conf['realPrimaryGroup'];
		$this->useSSL            = $conf['useSSL'];
	    $this->useTLS            = $conf['useTLS'];
    	$this->useSSO            = $conf['useSSO'];
	    $this->recursiveGroups   = $conf['recursiveGroups'];
